...
export function ItemsTable({
  ...
  if (readOnly) {
    ...
    return (
      <div className="space-y-0">
        {items.map((it, idx) => {
          const supplier  = it.entityName ?? entities.find((e) => e.id === it.entity_id)?.nome
  ...
  return (
    <div>
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold text-gray-700 truncate max-w-[220px] sm:max-w-none">
                    {it.descricao.trim() ? it.descricao : <span className="text-gray-300 font-normal">Item sem título</span>}
                  </span>
                </div>
                <button
                  type="button"
              ...
              <div className="space-y-3">
                ...
                {/* Quantidade + Valor Unitário + Total calculado */}
      ...
      {/* Rodapé: botão adicionar + total geral */}
